...
///// NOTE THIS FILE HAS BEEN MODIFIED FROM THE ORIGINAL.  THE FUNCTION image() HAS BEEN ALTERED.
...
class CaptchasDotNet
{
  ...
  // backup server
  //
  function image ($random = False, $id = 'captchas.net', $style = '')
  {
    $image = <<<EOT
        <a href="http://captchas.net"><img
            style="border: none; vertical-align: bottom; @STYLE@"
